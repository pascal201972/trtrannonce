 ...
 */
final class Version20220505170944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trt_profilcandidat (id INT AUTO_INCREMENT NOT NULL, profession_id INT DEFAULT NULL, experience_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, nom VARCHAR(100) DEFAULT NULL, prenom VARCHAR(100) DEFAULT NULL, cv VARCHAR(255) DEFAULT NULL, numero VARCHAR(50) NOT NULL, INDEX IDX_8E47E91CFDEF8996 (profession_id), INDEX IDX_8E47E91C46E90E27 (experience_id), UNIQUE INDEX UNIQ_8E47E91C79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trt_profilrecruteur (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, nom VARCHAR(100) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(8) DEFAULT NULL, ville VARCHAR(100) DEFAULT NULL, etablissement VARCHAR(20) DEFAULT NULL, numero VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_1834883479F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trt_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, valider TINYINT(1) NOT NULL, profil TINYINT(1) NOT NULL, init_motdepasse VARCHAR(255) DEFAULT NULL, expire INT DEFAULT NULL, UNIQUE INDEX UNIQ_B0E89F99E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trt_profilrecruteur DROP FOREIGN KEY FK_1834883479F37AE5');
        $this->addSql('DROP TABLE trt_annonce');
        $this->addSql('DROP TABLE trt_candidature');
